// JavaScript form validations paired with jQuery magic
// validateForm is the mastermind function that controls everything
// ValidateForm.prototype can have additional validations added,
// currently has email, password with number, password with capital letter,
// and password length at a minimum of 8 characters.
// showErrors displays the error messages associated with the validations

// REQUIRES: jQuery, form buttons, input types (email, password), #errors div
...
$(window).load(function(){
  ...
  function ValidateForm() {
    ...
    this.getErrors = function() {
      // ValidateForm objects - set these dynamically instead of hardcoding
